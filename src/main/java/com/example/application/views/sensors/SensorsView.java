...
@PageTitle("Sensors")
@CssImport("./styles/views/sensors/sensors-view.css")
public class SensorsView extends Div {

    Grid<SensorResponseDto> grid = new Grid<>(SensorResponseDto.class);
    private SensorService sensorService;
    TextField filterText = new TextField();

    public SensorsView(SensorService sensorService){
        this.sensorService = sensorService;
        addClassName("sensors-view");//css class name listview
        setSizeFull(); // makes the main view same size as the window
        configureGrid();
        add(grid, filterText);
        updateList();
        configureField();
    ...
    private void configureGrid() {
        ...
        grid.setSizeFull();
        grid.setColumns("sensorName", "createdAt", "updatedAt"); //configure the grid
    }
//
...
//
//    public SensorsView(@Autowired PersonService personService) {
