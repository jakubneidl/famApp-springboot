...
import com.example.application.data.arduino.ArduinoMessage;
import com.example.application.data.arduino.ArduinoMovementRequest;
import com.example.application.data.arduino.ArduinoPlantRequest;
import com.example.application.data.configuration.RestTemplateClient;
import com.example.application.data.domain.*;
import com.example.application.data.exception.CropCannotBePlantedException;
