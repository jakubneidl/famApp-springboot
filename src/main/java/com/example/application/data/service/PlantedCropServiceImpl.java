...
import com.example.application.data.exception.CropAlreadyPlantedInThisPosition;
import com.example.application.data.exception.CropNotFoundException;
import com.example.application.data.exception.PositionNotFoundException;
import com.example.application.data.mapper.CropMapper;
import com.example.application.data.mapper.PlantedCropMapper;
import com.example.application.data.mapper.PlantedCropPositionMapper;
import com.example.application.data.model.*;
import com.example.application.data.repository.CropRepository;
import com.example.application.data.repository.PlantedCropPositionRepository;
import com.example.application.data.repository.PlantedCropRepository;
